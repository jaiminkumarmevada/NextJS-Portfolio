          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <div className="flex gap-4">
                  ...
                  <motion.a
                    ...
                    href="https://in.linkedin.com/in/jaimin-mevada-a46b06213"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialLinkedin />
                  ...
                  <motion.a
                    ...
                    href="https://www.facebook.com/JaiminJMevada"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialFacebook />
                  ...
                  <motion.a
                    ...
                    href="https://www.instagram.com/jmn_mvd/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialInstagram />
              ...
              <motion.a
                ...
                href="jaiminmevada.it@gmail.com"
              >
                <p>jaiminmevada.it@gmail.com</p>
              </motion.a>
            </motion.div>
          </div>
        )}
